...
return [
    ...
    'attributes' => [
        ...
        'policy_holder_id' => 'بیمه گذار',
        'owner_id' => 'مالک وسیله نقلیه',
        'starts_at' => 'تاریخ شروع',
        'ends_at' => 'تاریخ پایان',
        'insurance_policy_number' => 'شماره بیمه نامه',
        'attachment_insurance_photo' => 'تصویر الحاقیه',
        'vehicle_card_up' => 'تصویر کارت ماشین (رو)',
        'vehicle_card_down' => 'تصویر کارت ماشین (پشت)',
    ],
];
