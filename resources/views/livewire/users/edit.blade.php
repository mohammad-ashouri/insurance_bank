    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form wire:submit="edit" class="p-6 text-gray-900 dark:text-gray-100 space-y-4">
                    <div class="grid grid-cols-2 gap-1 gap-y-2">
                        ...
                        <div class="space-y-1 w-full">
                            <x-input-label value="رمز عبور* (در صورت عدم نیاز به تغییر، خالی بگذارید)"/>
                    ...
                    <div class="px-6 py-3 text-left text-gray-900 dark:text-gray-100">
                        <x-send-button wire:loading.remove type="submit">ویرایش کاربر
                        </x-send-button>
